...
static NSString* MyApplicationID = @"NewAppPanel";
// Password should be sent to your e-mail after application was created
static NSString* MyPassword = @"78Hhu2ygL0od8e5CLUn9gPtp";
...
- (void)client:(Client *)sender didFinishDownloadData:(NSData *)downloadedData
{
   ...
   //https://www.googleapis.com/customsearch/v1?key=AIzaSyC-auuXHTsqbeRlyKtlZ3Ykew8_5wXNluM&cx=008119690503341524900:7jzu0uq8jvk&q=Dashon%20Howard
}
